...
# -*- coding: utf-8 -*-
"""
Created on Wed Jul 27 17:12:29 2022
...
class History_in_space():
    ...
    def year_2008(self):
        print("\n""Events That Happened in space 2008", "\n")
    ...
    def year_2011(self):
        print("\n","Events That Happened in space 2011", "\n")
        
class History_in_medical():
    
    def year_2008(self):
        print("\n""Events That Happened in medical 2008", "\n")
    ...
    def year_2011(self):
        print("\n","Events That Happened in medical 2011", "\n")
...
class History_in_sports():
    ...
    def year_2008(self):
        print("\n""Events That Happened in sports 2008", "\n")
    ...
    def year_2011(self):
        print("\n","Events That Happened in sports 2011", "\n")
